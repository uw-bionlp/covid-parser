...
public final class OpenNLPGrpc {
  ...
  public static final io.grpc.MethodDescriptor<edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionInput,
      edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionOutput> METHOD_DETECT_SENTENCES =
      io.grpc.MethodDescriptor.<edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionInput, edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionOutput>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "covid.parser.OpenNLP", "DetectSentences"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionInput.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionOutput.getDefaultInstance()))
  ...
  public static abstract class OpenNLPImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void detectSentences(edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionInput request,
        io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionOutput> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionInput,
                edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionOutput>(
  ...
  public static final class OpenNLPBlockingStub extends io.grpc.stub.AbstractStub<OpenNLPBlockingStub> {
    ...
    /**
     */
    public edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionOutput detectSentences(edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionInput request) {
  ...
  public static final class OpenNLPFutureStub extends io.grpc.stub.AbstractStub<OpenNLPFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionOutput> detectSentences(
        edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionInput request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DETECT_SENTENCES:
          serviceImpl.detectSentences((edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionInput) request,
              (io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.SentenceDetectionOutput>) responseObserver);
          break;
        default:
  ...
  private static abstract class OpenNLPBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.uw.bhi.bionlp.covid.parser.opennlp.OpenNLPOuterClass.getDescriptor();
    }
