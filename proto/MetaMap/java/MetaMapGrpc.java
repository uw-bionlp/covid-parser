...
public final class MetaMapGrpc {
  ...
  public static final io.grpc.MethodDescriptor<edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapInput,
      edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapOutput> METHOD_EXTRACT_NAMED_ENTITIES =
      io.grpc.MethodDescriptor.<edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapInput, edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapOutput>newBuilder()
          ...
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapOutput.getDefaultInstance()))
  ...
  public static abstract class MetaMapImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void extractNamedEntities(edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapInput request,
        io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapOutput> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapInput,
                edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapOutput>(
  ...
  public static final class MetaMapBlockingStub extends io.grpc.stub.AbstractStub<MetaMapBlockingStub> {
    ...
    /**
     */
    public edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapOutput extractNamedEntities(edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapInput request) {
  ...
  public static final class MetaMapFutureStub extends io.grpc.stub.AbstractStub<MetaMapFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapOutput> extractNamedEntities(
        edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapInput request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXTRACT_NAMED_ENTITIES:
          serviceImpl.extractNamedEntities((edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapInput) request,
              (io.grpc.stub.StreamObserver<edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.MetaMapOutput>) responseObserver);
          break;
        default:
  ...
  private static abstract class MetaMapBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.uw.bhi.bionlp.covid.parser.metamap.MetaMapOuterClass.getDescriptor();
    }
