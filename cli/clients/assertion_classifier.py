...
from proto.python.CovidParser_pb2 import AssertionClassifierInput, AssertionClassifierOutput
from proto.python.CovidParser_pb2_grpc import AssertionClassifierStub
